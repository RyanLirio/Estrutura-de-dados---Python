...
media_altura = sum(atleta[1] for atleta in atletas) / len(atletas) #sum -> soma #list comprehension é o laço #len(atletas) -> quantidade de atletas
print(f'Média de altura dos atletas: {media_altura:.2f}m')
